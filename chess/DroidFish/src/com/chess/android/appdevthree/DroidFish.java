...
import com.chess.android.appdevthree.ChessBoard.SquareDecoration;
import com.chess.android.appdevthree.activities.CPUWarning;
import com.chess.android.appdevthree.activities.EditBoard;
import com.chess.android.appdevthree.activities.EditPGNLoad;
import com.chess.android.appdevthree.activities.EditPGNSave;
import com.chess.android.appdevthree.activities.LoadScid;
import com.chess.android.appdevthree.activities.Preferences;
import com.chess.android.appdevthree.book.BookOptions;
import com.chess.android.appdevthree.engine.EngineUtil;
import com.chess.android.appdevthree.gamelogic.ChessParseError;
import com.chess.android.appdevthree.gamelogic.DroidChessController;
import com.chess.android.appdevthree.gamelogic.Move;
import com.chess.android.appdevthree.gamelogic.Pair;
import com.chess.android.appdevthree.gamelogic.PgnToken;
import com.chess.android.appdevthree.gamelogic.Position;
import com.chess.android.appdevthree.gamelogic.TextIO;
import com.chess.android.appdevthree.gamelogic.GameTree.Node;
import com.chess.android.appdevthree.gtb.Probe;
...
public class DroidFish extends Activity implements GUIInterface {
    ...
    private final static String bookDir = "UltimateChess";
    private final static String pgnDir = "UltimateChess" + File.separator + "pgn";
    private final static String engineDir = "UltimateChess" + File.separator + "uci";
    private final static String gtbDefaultDir = "UltimateChess" + File.separator + "gtb";
...
/*        case R.id.item_about:
        ...
        case R.id.item_Donate:
        	 Uri uri = Uri.parse("http://www.paypal.com");
        ...
        case RESULT_SELECT_SCID:
            if (resultCode == RESULT_OK) {
                ...
                if (pathName != null) {
                    ...
                    i.setAction("com.chess.android.appdevthree.loadScid");
                    i.putExtra("com.chess.android.appdevthree.pathname", pathName);
...
/*        case ABOUT_DIALOG: {
                ...
                public void onClick(DialogInterface dialog, int item) {
                    ...
                    case LOAD_PREV_GAME:
                        ...
                        if (currFT == FT_PGN) {
                            ...
                            i.setAction("com.chess.android.appdevthree.loadFilePrevGame");
                            i.putExtra("com.chess.android.appdevthree.pathname", currPathName);
                        } else {
                            i = new Intent(DroidFish.this, LoadScid.class);
                            i.setAction("com.chess.android.appdevthree.loadScidPrevGame");
                            i.putExtra("com.chess.android.appdevthree.pathname", currPathName);
                        }
                        startActivityForResult(i, RESULT_LOAD_PGN);
                        break;
            ...
            builder.setItems(lst.toArray(new CharSequence[lst.size()]), new DialogInterface.OnClickListener() {
                public void onClick(DialogInterface dialog, int item) {
                    ...
                    case LOAD_NEXT_GAME:
                        ...
                        if (currFT == FT_PGN) {
                            i = new Intent(DroidFish.this, EditPGNLoad.class);
                            i.setAction("com.chess.android.appdevthree.loadFileNextGame");
                            i.putExtra("com.chess.android.appdevthree.pathname", currPathName);
                        } else {
                            i = new Intent(DroidFish.this, LoadScid.class);
                            i.setAction("com.chess.android.appdevthree.loadScidNextGame");
                            i.putExtra("com.chess.android.appdevthree.pathname", currPathName);
                        }
                        startActivityForResult(i, RESULT_LOAD_PGN);
                        break;
    ...
    private final void savePGNToFile(String pathName, boolean silent) {
        ...
        i.setAction("com.chess.android.appdevthree.saveFile");
        i.putExtra("com.chess.android.appdevthree.pathname", pathName);
        i.putExtra("com.chess.android.appdevthree.pgn", pgn);
        i.putExtra("com.chess.android.appdevthree.silent", silent);
        startActivity(i);
    }
    ...
    private final void loadPGNFromFile(String pathName) {
        ...
        i.setAction("com.chess.android.appdevthree.loadFile");
        i.putExtra("com.chess.android.appdevthree.pathname", pathName);
        startActivityForResult(i, RESULT_LOAD_PGN);
    }
