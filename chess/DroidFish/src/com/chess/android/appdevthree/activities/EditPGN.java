...
package com.chess.android.appdevthree.activities;

import java.io.File;
import java.util.ArrayList;

import com.chess.android.appdevthree.R;
import com.chess.android.appdevthree.activities.PGNFile.GameInfo;
import com.chess.android.appdevthree.activities.PGNFile.GameInfoResult;
...
public class EditPGN extends ListActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String fileName = i.getStringExtra("com.chess.android.appdevthree.pathname");
        if (action.equals("com.chess.android.appdevthree.loadFile")) {
            ...
            workThread.start();
        } else if (action.equals("com.chess.android.appdevthree.loadFileNextGame") ||
                   action.equals("com.chess.android.appdevthree.loadFilePrevGame")) {
            pgnFile = new PGNFile(fileName);
            loadGame = true;
            boolean next = action.equals("com.chess.android.appdevthree.loadFileNextGame");
        ...
        } else if (action.equals("com.chess.android.appdevthree.saveFile")) {
            loadGame = false;
            pgnToSave = i.getStringExtra("com.chess.android.appdevthree.pgn");
            boolean silent = i.getBooleanExtra("com.chess.android.appdevthree.silent", false);
