...
public class LoadScid extends ListActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fileName = i.getStringExtra("com.chess.android.appdevthree.pathname");
        if (action.equals("com.chess.android.appdevthree.loadScid")) {
            ...
            workThread.start();
        } else if (action.equals("com.chess.android.appdevthree.loadScidNextGame") ||
                   action.equals("com.chess.android.appdevthree.loadScidPrevGame")) {
            boolean next = action.equals("com.chess.android.appdevthree.loadScidNextGame");
